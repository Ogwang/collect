...
package org.ipa.collect.android.utilities;
...
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.BEGINNING_OF_FORM;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.CONSTRAINT_ERROR;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.DELETE_REPEAT;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.END_OF_FORM;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.FINALIZE_ERROR;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.FORM_EXIT;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.FORM_FINALIZE;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.FORM_RESUME;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.FORM_SAVE;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.FORM_START;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.GOOGLE_PLAY_SERVICES_NOT_AVAILABLE;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.GROUP;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.HIERARCHY;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.LOCATION_PERMISSIONS_GRANTED;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.LOCATION_PERMISSIONS_NOT_GRANTED;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.LOCATION_PROVIDERS_DISABLED;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.LOCATION_PROVIDERS_ENABLED;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.LOCATION_TRACKING_DISABLED;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.LOCATION_TRACKING_ENABLED;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.PROMPT_NEW_REPEAT;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.QUESTION;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.REPEAT;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.SAVE_ERROR;
import static org.ipa.collect.android.logic.AuditEvent.AuditEventType.UNKNOWN_EVENT_TYPE;
