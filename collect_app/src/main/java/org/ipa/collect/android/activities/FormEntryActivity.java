...
import org.ipa.collect.android.R;
import org.ipa.collect.android.adapters.IconMenuListAdapter;
import org.ipa.collect.android.adapters.model.IconMenuItem;
import org.ipa.collect.android.application.Collect;
import org.ipa.collect.android.dao.FormsDao;
import org.ipa.collect.android.dao.helpers.ContentResolverHelper;
import org.ipa.collect.android.dao.helpers.FormsDaoHelper;
import org.ipa.collect.android.dao.helpers.InstancesDaoHelper;
import org.ipa.collect.android.events.ReadPhoneStatePermissionRxEvent;
import org.ipa.collect.android.events.RxEventBus;
import org.ipa.collect.android.exception.JavaRosaException;
import org.ipa.collect.android.external.ExternalDataManager;
import org.ipa.collect.android.fragments.MediaLoadingFragment;
import org.ipa.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.ipa.collect.android.fragments.dialogs.FormLoadingDialogFragment;
import org.ipa.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.ipa.collect.android.fragments.dialogs.NumberPickerDialog;
import org.ipa.collect.android.fragments.dialogs.ProgressDialogFragment;
import org.ipa.collect.android.fragments.dialogs.RankingWidgetDialog;
import org.ipa.collect.android.listeners.AdvanceToNextListener;
import org.ipa.collect.android.listeners.FormLoaderListener;
import org.ipa.collect.android.listeners.FormSavedListener;
import org.ipa.collect.android.listeners.PermissionListener;
import org.ipa.collect.android.listeners.SavePointListener;
import org.ipa.collect.android.location.client.GoogleLocationClient;
import org.ipa.collect.android.location.client.LocationClient;
import org.ipa.collect.android.location.client.LocationClients;
import org.ipa.collect.android.logic.AuditConfig;
import org.ipa.collect.android.logic.AuditEvent;
import org.ipa.collect.android.logic.FormController;
import org.ipa.collect.android.logic.FormController.FailedConstraint;
import org.ipa.collect.android.logic.FormInfo;
import org.ipa.collect.android.preferences.AdminKeys;
import org.ipa.collect.android.preferences.AdminSharedPreferences;
import org.ipa.collect.android.preferences.GeneralKeys;
import org.ipa.collect.android.preferences.GeneralSharedPreferences;
import org.ipa.collect.android.preferences.PreferencesActivity;
import org.ipa.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.ipa.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.ipa.collect.android.tasks.FormLoaderTask;
import org.ipa.collect.android.tasks.SaveFormIndexTask;
import org.ipa.collect.android.tasks.SavePointTask;
import org.ipa.collect.android.tasks.SaveResult;
import org.ipa.collect.android.tasks.SaveToDiskTask;
import org.ipa.collect.android.upload.AutoSendWorker;
import org.ipa.collect.android.utilities.ActivityAvailability;
import org.ipa.collect.android.utilities.ApplicationConstants;
import org.ipa.collect.android.utilities.DependencyProvider;
import org.ipa.collect.android.utilities.DialogUtils;
import org.ipa.collect.android.utilities.FileUtils;
import org.ipa.collect.android.utilities.ImageConverter;
import org.ipa.collect.android.utilities.MediaManager;
import org.ipa.collect.android.utilities.MediaUtils;
import org.ipa.collect.android.utilities.PermissionUtils;
import org.ipa.collect.android.utilities.SnackbarUtils;
import org.ipa.collect.android.utilities.SoftKeyboardUtils;
import org.ipa.collect.android.utilities.ToastUtils;
import org.ipa.collect.android.views.ODKView;
import org.ipa.collect.android.widgets.DateTimeWidget;
import org.ipa.collect.android.widgets.QuestionWidget;
import org.ipa.collect.android.widgets.RangeWidget;
import org.ipa.collect.android.widgets.StringWidget;
...
import static org.ipa.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.ipa.collect.android.preferences.GeneralKeys.KEY_BACKGROUND_LOCATION;
import static org.ipa.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.ipa.collect.android.utilities.PermissionUtils.finishAllActivities;
import static org.ipa.collect.android.utilities.PermissionUtils.areStoragePermissionsGranted;
