package org.ipa.collect.android.tasks.sms;
...
import org.ipa.collect.android.events.SmsRxEvent;
import org.ipa.collect.android.jobs.SmsSenderJob;
...
import org.ipa.collect.android.provider.InstanceProviderAPI;
import org.ipa.collect.android.tasks.sms.contracts.SmsSubmissionManagerContract;
import org.ipa.collect.android.tasks.sms.models.Message;
import org.ipa.collect.android.tasks.sms.models.SmsProgress;
import org.ipa.collect.android.tasks.sms.models.SmsSubmission;
import org.ipa.collect.android.upload.InstanceServerUploader;
import org.ipa.collect.android.utilities.ArrayUtils;
...
import static org.ipa.collect.android.tasks.sms.SmsSender.SMS_INSTANCE_ID;
import static org.ipa.collect.android.tasks.sms.SmsSender.SMS_MESSAGE_ID;
import static org.ipa.collect.android.tasks.sms.SmsSender.SMS_RESULT_CODE;
import static org.ipa.collect.android.tasks.sms.SmsSender.checkIfSentIntentExists;
import static org.ipa.collect.android.utilities.FileUtil.getFileContents;
import static org.ipa.collect.android.utilities.FileUtil.getSmsInstancePath;
